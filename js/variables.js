...
hero100PercentHeight = false,				//If true, the hero section (home) will be set with a minimum height of 100% window height. If false, hero height will be the height of its content.
	...
	//TWITTER VARIABLE
twitter_username = "dshook",				//Replace with your own Twitter username

	//GOOGLE MAP VARIABLES
map_canvas_id = "map_canvas",				//The HTML "id" of the map canvas
map_color = "#ad9fb3",						//Google map color
map_initial_zoom = 9,						//The initial zoom when Google map loads
map_initial_latitude = 40.0925012,			//Google map initial Latitude. If "null", the latitude of the first marked will be used
map_initial_longitude =-75.0972945,		//Google map initial Longitude. If "null", the longitude of the first marked will be used
...
countdownEndMsg = "It's Here!";			//Message to display when the countdown reaches the end